...
print(
    "The most valuable order is the Laptop order because it has the highest total amount."
)

print(
    "Cancelled orders should not be counted as revenue because they are not completed sales and the company does not receive money from them."
)